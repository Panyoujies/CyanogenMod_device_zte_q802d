...
const char CameraParameters::KEY_SUPPORTED_ZTE_BLINK_MODE[] = "supported-zte-blink-mode"; \
const char CameraParameters::KEY_ZTE_BLINK_MODE[] = "zte-blink-mode"; \
const char CameraParameters::KEY_SUPPORTED_ZTE_SMILE_MODE[] = "supported-zte-smile-mode"; \
